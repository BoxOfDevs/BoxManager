...
class FGMembersite {
    ...
    function Login() {
        ...
        $_SESSION["name_of_user"] = mysqli_query("SELECT name FROM users WHERE username='$username'");
        
        $_SESSION["email_of_user"] = mysqli_query("SELECT email FROM users WHERE username='$username'");
