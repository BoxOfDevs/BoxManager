<?PHP 
 ...
 //Site name 
 $fgmembersite->SetWebsiteName(json_decode(file_get_contents(__DIR__ . "/../configs/config.json"),true)["Site name"]); 
 ...
 $fgmembersite->InitDB(/*hostname*/json_decode(file_get_contents(__DIR__ . "/../configs/config.json"),true)["Database address"], 
